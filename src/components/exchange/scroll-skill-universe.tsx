...
const journey = [
  {
    ...
    title: "Temukan skill yang kamu butuhkan.",
    text: "Jelajahi skill dari mahasiswa lain berdasarkan kebutuhan, tujuan karier, dan pengalaman yang sudah terverifikasi.",
  },
  {
    number: "02",
    short: "Exchange",
    eyebrow: "Exchange Knowledge",
    title: "Belajar satu skill, bagikan satu skill.",
    text: "Satu sesi berdurasi 60 menit. Kamu belajar menggunakan Kredit, dan mendapatkan Kredit saat membagikan pengetahuan.",
  },
  {
    number: "03",
    short: "Build reputation",
    eyebrow: "Build Reputation",
    title: "Setiap exchange memperkuat profil kamu.",
    text: "Sesi, kontribusi, dan riwayat belajar kamu menjadi bukti kredibel di dalam Skill Passport.",
  },
  {
    number: "04",
    short: "Unlock",
    eyebrow: "Unlock Opportunities",
    title: "Kemampuan terverifikasi membuka pintu berikutnya.",
    text: "Peluang internship, proyek, dan kompetisi datang dari skill yang benar-benar kamu buktikan.",
  },
] as const;
